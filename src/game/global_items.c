...
Item globalItems[] = {
    ...
    {"Blind Gas", BOMB, "Turns off the light.", " ", 10, 250000, 0},
    {"Defensive", BOMB, "Makes noise and damage.", " ", 10, 250000, 0},
    ...
    {"Nightstick", SPECIAL, "Enlightening your path for a moment.", " ", 10, 250000, 0},
