...
void show_about_menu(Terminal *terminal,  WINDOW *window){
    ...
    while(key != 10){
        ...
        mvwprintw(window, terminal->yMax/2 + 8, terminal->xMax/2 - 141/2 + 1, "O objetivo do projeto final é a criação dum jogo \"Roguelike\" utilizando a biblioteca ncurses juntamente com a linguagem de programação C.");
